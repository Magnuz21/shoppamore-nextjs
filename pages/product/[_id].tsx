    ...
    <div className='w-full bg-white'>
        ...
        <div className='w-1/3 h-full flex flex-col gap-2'>
         ...
         <div className='px-2 py-4 border border-gray-400 rounded-md flex flex-col gap-6'>
           ...
           <IoMdHeartEmpty className='text-gray-600 text-2x1'/>
          </div>
           {/*Product Info*/}
         ...
         {/*Online Info*/}
         <div className='item-sm text-black flex flex-col gap-1'>
            <p>
            ...
            <p className='text-xs text-zinc-500 flex items-center gap-1'>
                Price when you purchase online 
         ...
         <div className='border-b-[1px] border-b-zinc-300 pb-4'>
            ...
            } className='w-32 h-10 bg-blue text-white rounded-full hover:bg-[#189AB4] duration-300'>
            Add to Cart</button>
         </div>
         {/*Deliver Option*/}
         <div>
            ...
            <div className='w-full grid grid-cols-3 gap-4 text-xs'>
                <div className='w-full border border-zinc-400 round-md flex flex-col items-center justify-center p-2'>
